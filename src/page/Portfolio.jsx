...
const Portfolio = () => {
  ...
  const marketingCentersPath = `${import.meta.env.BASE_URL}Markeeting Centers`;
  ...
  const projects = [
    ...
    { id: 6, category: "Consultancy", tag: "CONSULTANCY", title: "Consultancy Services", result: "40+ Centers", desc: "Consultancy delivered to above 40 centers.", img: `${import.meta.env.BASE_URL}skyTeam1.jpeg` },
    { id: 7, category: "Sky Skill Hub", tag: "SKY SKILL HUB", title: "Workshops & Training", result: "3 Workshops · 20+ Seminars · 15+ Training", desc: "3 workshops, above 20 seminars, and above 15 training programs delivered.", img: `${import.meta.env.BASE_URL}workshops/1.jpeg` },
